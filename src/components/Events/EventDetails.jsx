  ...
  return (
    <>
      {isDeleting && <Modal onClose={handleStopDelete}>
        <h2>Are you sure?</h2>
        <p>Do u really want to delete this event? this action cannot be undone.</p>
        ...
        {isErrorDeleting && <ErrorBlock title="Failed to delete event" message={deleteError.info?.message || "Failed to delete please try again later"}/>}
      </Modal>}
      <Outlet />
      <Header>
